...
func NewCosi(suite abstract.Suite, private kyber.Scalar) *Cosi {
	return &Cosi{
		suite:   suite,
		private: private,
	}
...
func VerifySignature(suite abstract.Suite, msg []byte, public kyber.Point, challenge, secret kyber.Scalar) error {
...
func verifyCommitment(suite abstract.Suite, msg []byte, commitment kyber.Point, challenge kyber.Scalar) error {
...
func VerifySignatureWithException(suite abstract.Suite, public kyber.Point, msg []byte, challenge, secret kyber.Scalar, exceptions []Exception) error {
...
func VerifyCosiSignatureWithException(suite abstract.Suite, public kyber.Point, msg []byte, signature *Signature, exceptions []Exception) error {
